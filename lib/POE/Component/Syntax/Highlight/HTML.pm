...
The module is a non-blocking wrapper around L<Syntax::Highlight::HTML> (although the
...
B<Mandatory>. Takes a string as a value which represents HTML code to syntax-highlight.
...
The C<in> key will contain the original HTML code.
